...
class Question
{
    ...
    #[Assert\Length(min: 5, minMessage: "Veuillez detailler le titre de la question", max: 2000, maxMessage: "Le titre est trop long")]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: "Veuillez renseigner ce champ")]
    #[Assert\Length(min: 5, minMessage: "Veuillez detailler votre question", max: 10000, maxMessage: "La question est trop longue")]
